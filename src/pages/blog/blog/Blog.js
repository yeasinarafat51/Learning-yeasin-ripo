...
const Blog = () => {
    return (
        <div>
            <h1>what is cors?</h1>
            <p>Cross-Origin Resource Sharing (cors) HTT is an -header based mechanism that allows a server to indicate any origins (domain, scheme, or port) other than its own from which a browser should permit loading resources</p>
